...
router.register('hours',views.HoursSensorViewset)
router.register('days',views.DaysSensorViewset)
router.register('weeks',views.WeeksSensorViewset)
router.register('hours',views.HoursAirKoreaViewset)
router.register('days',views.DaysAirKoreaViewset)
router.register('weeks',views.WeeksAirKoreaViewset)
